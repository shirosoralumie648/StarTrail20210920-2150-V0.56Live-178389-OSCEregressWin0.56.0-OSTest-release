...
SubProgram "d3d11 " {
Keywords { "GLOW_ON" "SDF_OUTLINE_ON" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "GLOW_ON" "SDF_OUTLINE_ON" "UNITY_UI_ALPHACLIP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "GLOW_ON" "SDF_OUTLINE_ON" "UNITY_UI_CLIP_RECT" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "GLOW_ON" "SDF_OUTLINE_ON" "UNITY_UI_ALPHACLIP" "UNITY_UI_CLIP_RECT" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
