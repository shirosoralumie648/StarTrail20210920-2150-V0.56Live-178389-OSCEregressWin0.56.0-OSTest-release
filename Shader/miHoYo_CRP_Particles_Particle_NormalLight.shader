...
//
///////////////////////////////////////////
Shader "miHoYo/CRP_Particles/Particle_NormalLight" {
Properties {
...
SubProgram "d3d11 " {
Local Keywords { "_CL_RGBA" "_NORMALMAP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" "_MATCAP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" "_NORMALMAP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" "_MATCAP" "_NORMALMAP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RA" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RA" "_MATCAP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RA" "_MATCAP" "_NORMALMAP" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "_CL_RGBA" "_USE_CUSTOMLIGHTDIR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" "_USE_CUSTOMLIGHTDIR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" "_MATCAP" "_USE_CUSTOMLIGHTDIR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RGBA" "_MATCAP" "_NORMALMAP" "_USE_CUSTOMLIGHTDIR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RA" "_MATCAP" "_USE_CUSTOMLIGHTDIR" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
Local Keywords { "CUSTOMDATA" "_CL_RA" "_MATCAP" "_NORMALMAP" "_USE_CUSTOMLIGHTDIR" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
